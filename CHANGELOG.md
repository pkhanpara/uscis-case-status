...
- Declare `setuptools` as a runtime dependency. `undetected-chromedriver` imports `distutils`,
  which Python 3.12 removed and a fresh 3.12 virtualenv does not provide, so installing 1.0.0 from
  PyPI and running the CLI failed with `ModuleNotFoundError: No module named 'distutils'`.
...
[1.0.1]: https://github.com/pkhanpara/uscis-case-status/releases/tag/v1.0.1
